package csvFileUpload.controller;
...
import csvFileUpload.message.ResponseMessage;
import csvFileUpload.model.CsvModel;
import csvFileUpload.service.CsvService;
...
public class CSVController {
	  ...
	  public ResponseEntity<List<CsvModel>> getAllTutorials() {
	    try {
	      List<CsvModel> csvModels = csvService.getAllTutorials();
